...
from utils.config import get_digitalocean_token, set_digitalocean_token, get_flomo_url, set_flomo_url
...
def main():
    ...
    digitalocean_parsers = digitalocean_parser.add_subparsers(description="Commands of DigitalOcean." )
    dg_config_parser = digitalocean_parsers.add_parser("config", help="Config DigitalOcean API token.")
    dg_config_parser.add_argument("--token", type=str, help="Set digitalOcean API token. Leave empty to get token from current config.")
    dg_config_parser.set_defaults(func=config_digitalocean)
    dg_update_parser = digitalocean_parsers.add_parser("update", help="Update DigitalOcean Firewall IPs.")
    ...
    flomo_config_parser.add_argument("--url", type=str, help="Set Flomo URL. Leave empty to get from current config.")
